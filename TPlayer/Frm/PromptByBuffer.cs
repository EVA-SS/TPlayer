...
namespace TPlayer
{
    public partial class PromptByBuffer : Form
    {
        IPromptByBuffer prompt = null;

        #region 初始化
        public PromptByBuffer(IPromptByBuffer prompt, string left, string middle = null)
        {
            this.prompt = prompt;
            this.left = left;
            this.middle = middle;
        ...
        {
            this.Location = new Point(prompt.iForm.Left + 10, prompt.iForm.Top + (prompt.iForm.Height - this.Height - 70));
        }
        ...
        public void Change(string left, string middle = null)
        {
            int count = 0;
        ...
        string middle = null;
        string left = null;
        Rectangle Text1_rect = new Rectangle(8, 0, 0, 0), Text2_rect = new Rectangle(0, 0, 0, 0);
        ...
        protected override void OnSizeChanged(EventArgs e)
        {
            ...
            Text1_rect.Height = Text2_rect.Height = this.Height;
    ...
    public interface IFormCore
    {
        Form iForm { get; }
    }
    public interface IPromptByBuffer : IFormCore
    {
        PromptByBuffer iPromptBuffer { get; set; }
    }
}
